...
public class ListBookingController {
    ...
    public String listBooking(Model model) {
        ...
        List<Booking> bookings = bookingRepository.findAllByCustomerOrderByIdDesc(user.getCustomer());

        Map<Long, Integer> bookingDays = new HashMap<>();
        Map<Long, String> bookingStatus = new HashMap<>();
        for (Booking booking : bookings) {
            ...
            bookingStatus.put(booking.getId(), booking.getStatus());
        }
